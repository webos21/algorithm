...
public class Dijkstra {
	...
	private void parseData(String dataPath) {
		...
		for (i = 0; setNum > 0; i++, setNum--) {
			...
			if (m != null && m.length == 2) {
				lstr = aqbr.readLine();
				gameCases[i] = new GameBean((i + 1), m[0], m[1], lstr);
			}
		}
	...
	public static void main(String[] args) {
		Dijkstra mainObject = new Dijkstra();
	...
	private class GameBean implements Runnable {
		...
		public GameBean(int cn, String l, String t, String o) {
			this.caseNo = cn;
			this.charNo = Integer.parseInt(l);
			this.repeatNo = Integer.parseInt(t);
			this.srcString = o;
		}
		...
		public void run() {
			...
			sb.append(charNo).append(' ').append(repeatNo).append(" / ");
